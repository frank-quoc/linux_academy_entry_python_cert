...
# 2) Add 'kevin', 'bob', and 'alice' to the users list in that order w/o reassigning the variable.
users.append('kevin')
users.append('bob')
users.append('alice')
...
assert users == ['kevin', 'melody', 'alice', 'andy', 'wanda', 'jim'], \
    f"Expected `users` to be ['kevin', 'melody', 'alice', 'andy', 'wanda', 'jim'] but got: {repr(users)}"
